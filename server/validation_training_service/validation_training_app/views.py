...
import os
import json
from .data_preprocessing import load_data, create_test_train_validationset
from .training import build_model, train_model, save_serving_model
# from .evaluation import generate_report
from .evaluation_v2 import generate_report
...
def test_train_model(request):
    if request.method == 'POST':
        ...
        gcs_report_path = f"{BASE_MODEL_PATH}/{BASE_REPORT_PATH}/{versioned_model_name}_report.json"
        ...
        report_content = generate_report(model, test_dataset)
